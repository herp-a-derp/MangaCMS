...
cdef class _ZipDecrypter:
	...
	def __call__(self, data):
		...
		python.PyBytes_AsStringAndSize(data, &data_s, &datalen)
		ret = python.PyBytes_FromStringAndSize(NULL, datalen)
		ret_s = python.PyBytes_AsString(ret)
		for 0 <= i < datalen:
			k = self.key2 | 2
